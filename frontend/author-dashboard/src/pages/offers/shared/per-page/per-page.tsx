...
import { Button, ChevronDownIcon, Dropdown, SelectOption, useTableContext, Tooltip, useOpen } from 'phoqer';
import { useReduceAnimations, useOffersContext } from 'phoqer-shared';
...
export const PerPage = (): JSX.Element => {
    ...
    const { perPage, setPerPage } = useOffersContext();
