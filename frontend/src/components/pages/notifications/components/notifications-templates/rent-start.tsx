...
const RentStart = ({ value }: IProps): ReactElement => {
    const css = useStyles();
    return (
        <NotificationsContainer
            ...
            footer={
                <>
                    <Button className={css.btn}>Одобрить запрос</Button>
                    <Button className={css.btn}>Отклонить</Button>
                </>
            }
        >
