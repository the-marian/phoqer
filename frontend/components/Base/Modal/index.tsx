...
const Modal = (): ReactElement => {
    ...
    const css = useStyles();
    const { modal, size, dom } = useSelector<IState, IModal>(state => state.modal);
    ...
    const handleBackDrop = (event: MouseEvent<HTMLDivElement> | TouchEvent<HTMLDivElement>): void => {
    ...
    return modal ? (
        <div className={css.wrp} onMouseDown={handleBackDrop} onTouchEnd={handleBackDrop} aria-hidden>
