...
const useStyles = createUseStyles((theme: Theme) => ({
    ...
    // TODO убрать приставки user/info
    userInfo: {
        width: '65%',
        display: 'flex',
        flexWrap: 'wrap',
    ...
    infoGoods: {
        color: '#999999', // TODO используем только цвета, которые лежат в theme.palette, если в макете какой-то другой цвет - не верь ему
    },
    infoOpinion: {
        width: '100%',
        display: 'flex',
        ...
        <div className={css.container}>
            <div className={css.userInfo}>
                <div className={css.infoItems}>
                    <div>
                        <span className={css.infoGoods}>Соответствие товара с описанием:</span> 5/5
                    </div>
                    <div>
                        <span className={css.infoGoods}>Коммуникация:</span> 5/5
                    </div>
                    <div>
                        <span className={css.infoGoods}>Скорость отклика:</span> в течение часа
                    </div>
                </div>
                <div className={css.infoOpinion}>
                    {/* TODO использовать тег <p></p> или <span></span> для текста */}
