    ...
    <div className={css.root}>
      <div className={css.success}>
        ...
        <p className={css.text}>
          В ближайшее время мы проверим ваше объявление и опубликуем его. Вы
          можете отслеживать статус вашего объявления в личном кабинете.
        </p>
      ...
      <div className={css.top}>
        ...
        <h1 className={css.topTitle}>
          Выводите товар в топ на месяц абсолютно бесплатно
        </h1>
        <p className={css.text}>
          Ляля тополя ляля тополя тополя ляля тополя тополя ляля тополя тополя
          ляля тополя. Тополя ляля тополя тополя ляля тополя.
        </p>
